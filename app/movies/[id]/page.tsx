  ...
  return (
    <div>
      ...
      <div className="relative w-full h-[65vh] min-h-[380px]">
        ...
        <Link
          href="/movies"
          className="absolute top-20 left-6 z-20 w-8 h-8 rounded-full bg-black/50 border border-neutral-800 flex items-center justify-center text-neutral-400 hover:text-white transition-colors"
        >
        ...
        <div className="absolute bottom-8 left-0 right-0 px-6 md:px-12 lg:px-16 z-10">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-3 tracking-tight max-w-2xl">{movie.title}</h1>
          ...
          <div className="flex items-center gap-3">
            <Link
              ...
              className="flex items-center gap-2 px-5 py-2 bg-white text-black font-semibold rounded-md text-sm transition-all hover:bg-neutral-200"
            >
